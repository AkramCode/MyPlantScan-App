...
export const slides: OnboardingSlide[] = [
  ...
  },
  {
    ...
    description: 'Allow camera to scan plants.',
    icon: 'Camera',
    accent: Colors.primary,
    requiresPermission: 'camera',
    permissionTitle: 'Camera permission',
    permissionDescription: 'Used for scanning. Photos stay private.',
  },
  {
    key: 'library-permission',
    title: 'Photo library access',
    subtitle: 'Import & analyze photos',
    description: 'Allow importing existing photos.',
    icon: 'Image',
    accent: Colors.primary,
    requiresPermission: 'library',
    permissionTitle: 'Library permission',
    permissionDescription: 'Used to import photos. Private & secure.',
  },
  {
    key: 'garden',
    title: 'Plant library',
